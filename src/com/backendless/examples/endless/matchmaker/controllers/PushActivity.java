...
public class PushActivity extends Activity
{
  ...
  public void onCreate( Bundle savedInstanceState )
  {
    ...
    String userName = intent.getStringExtra( Defaults.NAME_PROPERTY );

    ((TextView) findViewById( R.id.pushMessage )).setText( userName + " " + getResources().getString( R.string.textfield_push_message ) );
