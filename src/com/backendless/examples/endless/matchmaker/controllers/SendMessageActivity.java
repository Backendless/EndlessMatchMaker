...
public class SendMessageActivity extends Activity
{
  ...
  public void onCreate( Bundle savedInstanceState )
  {
    ...
    GeoPoint targetUserGeoPoint = (GeoPoint) getIntent().getSerializableExtra( Defaults.TARGET_USER_GEO_POINT_BUNDLE_TAG );
    ...
    ((TextView) findViewById( R.id.title )).setText( "Msg to " + targetUserName );
  ...
  //Callbacks section
  private AsyncCallback<MessageStatus> messageSendCallback = new ResponseAsyncCallback<MessageStatus>( SendMessageActivity.this )
  {
    @Override
  ...
  private View.OnClickListener sendListener = new View.OnClickListener()
  {
    ...
    public void onClick( View view )
    {
      ...
      Backendless.Messaging.publish( Defaults.MESSAGING_CHANNEL, String.valueOf( messageText.getText() ), publishOptions, null, messageSendCallback );
    }
  };
